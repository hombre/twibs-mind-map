...
(function (TwibsMindMaps) {
    class MindMap {
        constructor(container) {
            ...
            this.turnWheel = (e) => {
                if (e.ctrlKey == this.useCtrlForWheel) {
                    e.preventDefault();
            ...
            window.addEventListener("resize", () => this.updateScale(this.scale));
            ...
            container.addEventListener("keyup", (e) => {
                if (!e.altKey && !e.metaKey) {
                    if (e.ctrlKey) {
                        ...
                        if (!e.shiftKey && this.isEditing && this.isOneSelected()) {
        ...
        constructor(mindMap) {
            ...
            this.computeSizes = () => {
                ...
                this.connectionOffsets = this.connectionElements.map(ce => {
                    ...
                    return new Point(parseInt(ceStyle.left || "0", 10) + parseInt(ceStyle.width || "0", 10) / 2 - this.width / 2, parseInt(ceStyle.top || "0", 10) + parseInt(ceStyle.height || "0", 10) / 2 - this.height / 2);
                });
            };
            this.layout = (force) => {
                if (this.level() == 1) {
